...
copia de /etc/passwd modificada a nuestros intereses y sobre-escribir el legítimo como root con dd. Primero creamos el hash para la password con openssl:  
> which openssl  
> openssl passwd
...
Borramos la “x” de root correspondiente a la password y la cambiamos por nuestro hash. Guardamos. Ahora, la hora de la verdad. Probamos:  
